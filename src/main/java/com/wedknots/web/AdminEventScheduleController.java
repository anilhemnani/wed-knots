...
@Slf4j
@Controller
@RequestMapping("/admin/events/{eventId}/schedule")
...
public class AdminEventScheduleController {
    ...
    public String listActivities(@PathVariable Long eventId,
        ...
        return "admin/event_schedule_list";
    }
    ...
    public String newActivity(@PathVariable Long eventId, Model model) {
        ...
        return "admin/event_activity_form";
    }
    ...
    public String createActivity(@PathVariable Long eventId,
        ...
        return "redirect:/admin/events/" + eventId + "/schedule";
    }
